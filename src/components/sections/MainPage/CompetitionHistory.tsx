...
export default function CompetitionHistory() {
    return (
        <div className="w-full max-w-5xl min-h-[100vh] flex flex-col items-center justify-center">
            <p className="font-bold text-2xl">자체 경진대회</p>
            <h1 className="text-3xl font-bold mb-4">개최 이력</h1>
