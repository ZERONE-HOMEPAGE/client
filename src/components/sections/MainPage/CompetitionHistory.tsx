...
export default function CompetitionHistory() {
    return (
        <div className="w-full min-h-[100vh] flex flex-col items-center justify-center p-4">
            ...
            <Card className=" w-[95%] md:w-[60%] h-48 !bg-gray-400 text-white mb-4 flex flex-row items-end justify-evenly p-0">
                <div className="flex flex-col items-end justify-end h-full">
                    <h1 className="text-4xl md:text-6xl font-bold -mb-4 leading-none translate-y-2">HEPC</h1>
                </div>
                <ul className="p-4">
                    <li>개최 시기: 매년 5월 초</li>
                    <li>참가 규모: 80~100명</li>
            ...
            <Card className=" w-[95%] md:w-[60%] h-48 !bg-gray-400 text-white mb-8 flex flex-row items-end justify-evenly">
                <ul className="p-4">
                ...
                <div className="flex flex-col items-end justify-end h-full">
                    <h1 className="text-4xl md:text-6xl font-bold -mb-4 leading-none translate-y-2">ZOAC</h1>
                </div>
            </Card>
